...
# 加载用于模型预测的数据
'''
   lonlat  2019-04-02_07-30  2019-04-02_07-31  2019-04-02_07-32  ...  2019-04-02_08-36  2019-04-02_08-37  2019-04-02_08-38  2019-04-02_08-39
0
1
每5列取一列，用取出的结果的前12列作为模型输入，第12列作为模型输出【ground truth】
例如当index=0时，
select_data = [7:31, 7:36, ..., 8:26, 8:31, 8:36]
dataForPred = [7:31, 7:36, ..., 8:26]
dataGroudTruth = [8:31]
'''
