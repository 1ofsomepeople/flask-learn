...
def Convertor(x, y, arr):
    ...
    y_temp = abs(y) / arr[9]
    y_temp1 = arr[2] + arr[3] * y_temp + arr[4] * y_temp * y_temp + arr[
        5] * y_temp * y_temp * y_temp + arr[
            6] * y_temp * y_temp * y_temp * y_temp + arr[
                7] * y_temp * y_temp * y_temp * y_temp * y_temp + arr[
                    8] * y_temp * y_temp * y_temp * y_temp * y_temp * y_temp
...
def convertPointList(lonlatList, oriType, aimType):
    ...
    if (len(lonlatList) <= 0):
        return []
    elif ((not isinstance(lonlatList, (list))) or (not isinstance(lonlatList[0], (list)))
